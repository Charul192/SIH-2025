...
export default function PlanyouTrip() {
  ...
  const func = (event)=>{
    ...
    if(val.length > 0){
      ...
      setSuggestion(suggestions => filteredSuggestions);
    }
    else setSuggestion([]);
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <div className="w-full">
                ...
                <div className="relative mt-2">
                  ...
                  <input type="text" value={startLocation} id="st" onChange={(e) => func(e)} className="block w-full rounded-md border-0 bg-gray-100 dark:bg-white/5 py-3 pl-10 pr-3 text-lg" placeholder="e.g., Amritsar" required />
                </div>
              </div>
              ...
              <div className="w-full">
                ...
                <div className="relative mt-2">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500"> <LocationPinIcon /> </div>
                  <input type="text" value={endLocation} id="end" onChange={(e) => func(e)} className="block w-full rounded-md border-0 bg-gray-100 dark:bg-white/5 py-3 pl-10 pr-3 text-lg" placeholder="e.g., Ludhiana" required />
                </div>
              </div>
            </div>
