...
// Data for each FAQ section (no changes needed here)
const faqSections = [
    {
        id: 1,
                            ...
                            <div key={section.id} className={`rounded-lg border transition-all duration-300 ${Dark ? 'border-white/10 bg-gray-900/50' : 'border-slate-200 bg-slate-50'}`}>
                                ...
                                >
                                    <span className="flex items-center gap-4">
                                        ...
                                        <span className="text-xl font-semibold">{section.question}</span>
                                    </span>
                                    <ChevronDownIcon
                                ...
                                >
                                    <div className="overflow-hidden">
                                        {/* FIX: Accordion content is now theme-aware, using prose for nice styling */}
